...
@section("content")
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            快捷方式：@include("layouts.shortcut01") || {!! link_to("User\Role/create","增加角色") !!} |  {!! link_to("User\Role/$task->id/edit","编辑角色") !!} 
        </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    {{ Form::model($task, ["url"=>"User\Role/$task->id", "method" => "DELETE", "class" => "form-horizontal"]) }}
                        ...
                        <div class="col-sm-6">
                                {{ Form::text("right", $task->right, ["class"=>"form-control", 'readonly'=>'ReadOnly']) }}
                            </div>
                        </div>
                        <div class="form-group">
